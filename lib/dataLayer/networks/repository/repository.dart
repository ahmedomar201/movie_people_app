...
abstract class Repository {
  Future<Either<String, PersonModel>> getPerson(int page);
}
...
class RepoImplementation extends Repository {
  ...
  @override
  Future<Either<String, PersonModel>> getPerson(int page) async {
    return basicErrorHandling<PersonModel>(
      onSuccess: () async {
        var response = await dioHelper.get(url: "3/person/popular?page=$page&api_key=$apiKey");
      ...
      onServerError: (exception) async {
        ...
        if (cachedData != null) {
          ...
          return Right(PersonModel.fromJson(cachedData));
        }
